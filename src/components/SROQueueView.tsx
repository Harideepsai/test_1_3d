...
export const SROQueueView: React.FC<SROQueueViewProps> = ({ onSelectBuildingForMap }) => {
                          ...
                          <tr key={unit.property_id} className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-3 py-2.5 text-slate-700">
                              <span className="text-[#1e3a8a] font-bold">
                                {geom?.bottom_height.toFixed(1)}m – {geom?.top_height.toFixed(1)}m
                              </span>
                              <div className="text-[10px] text-slate-500 font-sans">
                                Level {floor.floor_number} (&Delta;h={(geom?.height || 3).toFixed(1)}m)
                              </div>
                            </td>
                            ...
                            <td className="px-3 py-2.5 text-right font-sans">
                              <button
                                id={`btn-edit-flat-${unit.flat_number.replace(/\s+/g, '-').toLowerCase()}`}
                                ...
                                title={`Edit details of ${unit.flat_number}`}
                              >
