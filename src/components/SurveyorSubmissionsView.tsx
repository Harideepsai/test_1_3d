    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6 font-sans">
      ...
      <div className="p-5 rounded-lg bg-white border border-slate-200 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2 rounded bg-[#1e3a8a] hover:bg-blue-900 text-white font-semibold text-xs flex items-center gap-2 shadow-xs transition-colors cursor-pointer self-start md:self-auto shrink-0"
        >
          <UploadCloud className="w-4 h-4" />
          <span>Ingest New 3D Model / Coordinates</span>
        </button>
      </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    <div className="text-xs text-slate-600 flex items-center gap-1.5">
                      ...
                      <span className="font-mono text-slate-400">
                        ({bld.latitude.toFixed(4)}°N, {bld.longitude.toFixed(4)}°E)
                      </span>
                    </div>
                  </div>
